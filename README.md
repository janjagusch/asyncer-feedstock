...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asyncer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14982&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asyncer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asyncer` can be installed with:

```
conda install asyncer
```

It is possible to list all of the versions of `asyncer` available on your platform with:
